...
class TextImageGenerator:
    ...
    def __init__(self, 
        ...
        img_dirpath = join(dirpath, 'charDeg')
        desc_dirpath = join(dirpath, 'clean')
        self.samples = []
...
def train(img_w, load=False):
    ...
    tiger_train = TextImageGenerator('img_in/val', img_w, img_h, batch_size, downsample_factor)
    tiger_train.build_data()
    tiger_val = TextImageGenerator('img_in/val', img_w, img_h, batch_size, downsample_factor)
    ...
    if load:
        model = load_model('./model-2019-06-30_21-21-39-788130.h5', compile=False)
...
tiger_test = TextImageGenerator('img_in/test', 315, 60, 8, 4)
